...
) : PageModel
{
   ...
   /// <summary>
   /// Constructs the route values required to redirect the user to the reauthentication (connect) page.
   /// </summary>
   /// <returns>
   /// A <see cref="RouteValueDictionary"/> containing the area, SQL server, and SQL user name for reauthentication.
   /// </returns>
   private RouteValueDictionary GetReauthenticateRouteValues() {
   ...
   public async Task<IActionResult> OnGetAsync() {
      ...
      if (tmppwd is null)
      {
         return RedirectToPage("connect", GetReauthenticateRouteValues());
      }
